...
type CompanyExtendedRefLenses struct {
	...
	ExtendedO __lens_option.LensO[*CompanyExtended, string]
	// prisms
	NameP __prism.Prism[*CompanyExtended, string]
	AddressP __prism.Prism[*CompanyExtended, Address]
	CEOP __prism.Prism[*CompanyExtended, Person]
	WebsiteP __prism.Prism[*CompanyExtended, *string]
	ExtendedP __prism.Prism[*CompanyExtended, string]
}
