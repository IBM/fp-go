...
type (
	...
	Kleisli[S, A, B any] = common.OptionalKleisli[S, A, B]
	...
	Operator[S, A, B any] = common.OptionalOperator[S, A, B]
)
...
func Compose[S, A, B any](ab Optional[A, B]) Operator[S, A, B] {
	return common.OptionalComposeOptional[S](ab)
}
...
func ComposeRef[S, A, B any](ab Optional[A, B]) Operator[*S, A, B] {
	return common.OptionalComposeOptionalRef[S](ab)
}
