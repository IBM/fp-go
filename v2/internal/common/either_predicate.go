...
// EitherExists creates a predicate that tests whether an Either value is Right and its value satisfies the given predicate.
...
// EitherExistsLeft creates a predicate that tests whether an Either value is Left and its value satisfies the given predicate.
...
// EitherForAll creates a predicate that tests whether an Either value is Left or its Right value satisfies the given predicate.
...
// EitherForAll implements a natural transformation from predicates on T to predicates on Either[E, T],
