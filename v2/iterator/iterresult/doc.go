...
// Package iterresult provides the SeqResult type, which represents an iterator
// that yields Result values, combining iteration with error handling.
//
// SeqResult[A] is defined as iter.Seq[Result[A]], representing a sequence
// of values that can each be either an error or a success value of type A.
//
// # Fantasy Land Specification
//
// This package implements a monad transformer combining iteration with Result for error handling.
