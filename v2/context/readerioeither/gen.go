...
func TraverseTuple1[F1 ~func(A1) ReaderIOEither[T1], T1, A1 any](f1 F1) Kleisli[tuple.Tuple1[A1], tuple.Tuple1[T1]] {
...
func TraverseSeqTuple1[F1 ~func(A1) ReaderIOEither[T1], T1, A1 any](f1 F1) Kleisli[tuple.Tuple1[A1], tuple.Tuple1[T1]] {
	return func(t tuple.Tuple1[A1]) ReaderIOEither[tuple.Tuple1[T1]] {
		return apply.TraverseTuple1(
			Map[T1, tuple.Tuple1[T1]],
			f1,
...
func TraverseParTuple1[F1 ~func(A1) ReaderIOEither[T1], T1, A1 any](f1 F1) Kleisli[tuple.Tuple1[A1], tuple.Tuple1[T1]] {
	return func(t tuple.Tuple1[A1]) ReaderIOEither[tuple.Tuple1[T1]] {
		return apply.TraverseTuple1(
			Map[T1, tuple.Tuple1[T1]],
			f1,
