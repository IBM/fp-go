...
// MonadChainIdiomatic sequences a [ReaderReaderIOResult] with an idiomatic Kleisli function.
// The success value of fa is passed to f; errors short-circuit the chain.
func MonadChainIdiomatic[R, A, B any](fa ReaderReaderIOResult[R, A], f KleisliIdiomatic[R, A, B]) ReaderReaderIOResult[R, B] {
...
func MonadChainFirstIdiomatic[R, A, B any](fa ReaderReaderIOResult[R, A], f KleisliIdiomatic[R, A, B]) ReaderReaderIOResult[R, A] {
...
func MonadTapIdiomatic[R, A, B any](fa ReaderReaderIOResult[R, A], f KleisliIdiomatic[R, A, B]) ReaderReaderIOResult[R, A] {
...
func MonadChainLeftIdiomatic[R, A any](fa ReaderReaderIOResult[R, A], f KleisliIdiomatic[R, error, A]) ReaderReaderIOResult[R, A] {
...
func ChainLeftIdiomatic[R, A any](f KleisliIdiomatic[R, error, A]) func(ReaderReaderIOResult[R, A]) ReaderReaderIOResult[R, A] {
